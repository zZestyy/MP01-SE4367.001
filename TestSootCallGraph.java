...
//		//set classpath
	    ...
	    long strt = System.currentTimeMillis();			// start stop watch
	    ...
	    long end = System.currentTimeMillis();			// end stop watch
	    
	    System.out.println( "Total Runtime: " + (end - strt) + " milliseconds." );		// duration
	}
